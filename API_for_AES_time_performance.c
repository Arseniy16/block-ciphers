...
int main() {
    ...
    FILE* file_1;
    file_1 = fopen("logs/AES_1_encryption.txt", "w");
    for (i = 0; i < 6; i++) {
        // encryption
        for (j = 0; j < 10; j++) {
    ...
    // print results for AES-1
    FILE* file_2;
    file_2 = fopen("logs/AES_1_decryption.txt", "w");
    for (i = 0; i < 6; i++) {
        // decryption
        for (j = 0; j < 10; j++) {
    ...
    FILE* file_3;
    file_3 = fopen("logs/AES_2_encryption.txt", "w");
    for (i = 0; i < 6; i++) {
        // encryption
        for (j = 0; j < 10; j++) {
    ...
    // print results for AES-2
    FILE* file_4;
    file_4 = fopen("logs/AES_2_decryption.txt", "w");
    for (i = 0; i < 6; i++) {
        // decryption
        for (j = 0; j < 10; j++) {
    ...
    FILE* file_5;
    file_5 = fopen("logs/AES_3_encryption.txt", "w");
    for (i = 0; i < 6; i++) {
        // encryption
        for (j = 0; j < 10; j++) {
    ...
    // print results for AES-3
    FILE* file_6;
    file_6 = fopen("logs/AES_3_decryption.txt", "w");
    for (i = 0; i < 6; i++) {
        // decryption
        for (j = 0; j < 10; j++) {
    ...
    FILE* file_7;
    file_7 = fopen("logs/DES_encryption.txt", "w");
    for (i = 0; i < 6; i++) {
        // encryption
        for (j = 0; j < 10; j++) {
    ...
    // print results for DES
    FILE* file_8;
    file_8 = fopen("logs/DES_decryption.txt", "w");
    for (i = 0; i < 6; i++) {
        // decryption
        for (j = 0; j < 10; j++) {
    ...
    FILE* file_9;
    file_9 = fopen("logs/Blowfish_encryption.txt", "w");
    for (i = 0; i < 6; i++) {
        // encryption
        for (j = 0; j < 10; j++) {
    ...
    // print results for Blowfish
    FILE* file_10;
    file_10 = fopen("logs/Blowfish_decryption.txt", "w");
    for (i = 0; i < 6; i++) {
        // decryption
        for (j = 0; j < 10; j++) {
